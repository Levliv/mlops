...
--------
### Отчет о версионирование данных и моделей (ДЗ2)
#### 1. Настроен Git LFS для версионирования данных
- Использованный датасет: [Wine Quality Dataset](https://www.kaggle.com/datasets/yasserh/wine-quality-dataset/data)
- Установлен и настроем Git LFS
- Настроен remote storage

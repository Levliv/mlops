...
- Стратегия ветвления: Feature Branch Workflow
    ...
    - `feature/hwN` Ветки для выполнения домашних заданий. N - номер дз. Отделяются от master. После выполнения задания и прохождения тестов, проверки вливается в master
